...
const { data: userDataResponse, isLoading, isError } = usegetUserNameByLikeCount();

// API가 배열로 반환할 경우 첫 번째(좋아요가 가장 많은) 유저 선택
const userDataArray = userDataResponse?.data || userDataResponse;
