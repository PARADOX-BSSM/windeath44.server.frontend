...
export const memorial_application = `${protocol}${server}/memorial_applications`; //추모관 신청
...
// export const memorial = `${protocol}${server}:4335/memorials`; //추모관
// export const memorial_application = `${protocol}${server}:4334/applications`; //추모관 신청
